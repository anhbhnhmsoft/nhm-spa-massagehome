...
enum ConfigName: string
{
    ...
    case IOS_MIN_SUPPORTED_VERSION = 'IOS_MIN_SUPPORTED_VERSION';
    case IOS_LATEST_VERSION = 'IOS_LATEST_VERSION';
    case ANDROID_MIN_SUPPORTED_VERSION = 'ANDROID_MIN_SUPPORTED_VERSION';
    case ANDROID_LATEST_VERSION = 'ANDROID_LATEST_VERSION';
    case APPSTORE_URL = 'APPSTORE_URL';
    case CHPLAY_URL = 'CHPLAY_URL';
    case MOBILE_MAINTENANCE = 'MOBILE_MAINTENANCE';
