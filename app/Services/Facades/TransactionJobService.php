...
class TransactionJobService extends BaseService
{
    ...
    ): ServiceReturn
    {
        return $this->execute(
            callback: function () use ($bookingId, $data) {
                ...
                return $this->processAutomaticCancelRefund($booking, $data);
            },
            useTransaction: true,
        );
    }

    public function handleAutoCancelBooking(
        string $bookingId,
        array $data = []
    ): ServiceReturn
    {
    ...
    {
        if (!$transactionId) {
            return ServiceReturn::error(__("error.invalid_data"));
        }

        return $this->walletTransactionStatusService->approveTransaction((int) $transactionId);
    }
    ...
    public function handleCancelWithdrawRequest($transactionId)
    {
        ...
        return $this->walletTransactionStatusService->cancelTransaction((int) $transactionId);
    }
